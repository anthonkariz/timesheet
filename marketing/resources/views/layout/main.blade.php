...
<head>
  ...
  <title>Holdons online marketing  | Dashboard</title>
  ...
  <link rel="stylesheet" href="{{ URL::asset('css/ionicons.min.cs') }}" />
  <!-- Theme style -->
  ...
  <!-- Morris chart -->
<style type="text/css">
  .parsley-mincheck,.parsley-required{
    color: red;
  }
</style>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Holdons</b>UK</span>
    </a>
...
<!-- FastClick -->
<script src="{{ URL::asset('js/jfastclick.js') }}"></script>
...
<script>
  jQuery(document).ready(function($) {
    ...
    $('#start_time1').timepicker({ 'timeFormat': 'H:i:s' });
    $('.tbbat').click(function(event) {
      /* Act on the event */
